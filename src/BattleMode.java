...
public class BattleMode {
			...
			while(true)	{
		      for(GameCharacter character : characters) {
		    	  ...
		    	  if(party.isAlive() && health1 >= 0 && health2 >= 0 && health3 >= 0) {
		    		  System.out.println(party.getName() + " have won!");
		    		  System.out.println("Congrats you have taken over Mars!");
		    		  break outerLoop;
		    	  }
		    	  else if(!party.isAlive()) {
		    		  System.out.println(party.getName() + "have been defeated!");
		    		  System.out.println("The aliens get to keep their planet!");
		    		  break outerLoop;
		    	  }
	...
	private static void getAttack(GameCharacter character, String enemy1, String enemy2, String enemy3) 
	{
		...
		if(BattleMode.health1 > 0 && BattleMode.health2 > 0 && BattleMode.health3 > 0) {
			...
			System.out.println(enemy1 + ", " + enemy2 + ", " + enemy3 );
			System.out.println("Chose one: ENEMY1, ENEMY2, ENEMY3");
			target = input.nextLine().trim().toUpperCase();
		}
		else if(BattleMode.health1 <= 0 && BattleMode.health2 > 0 && BattleMode.health3 > 0) {
			System.out.println("Who would you like to attack? Currently alive enemies are:");
			System.out.println( enemy2 + ", " + enemy3 );
			System.out.println("Chose one: ENEMY2, ENEMY3");
			target = input.nextLine().trim().toUpperCase();
		}
		else if(BattleMode.health1 > 0 && BattleMode.health2 <= 0 && BattleMode.health3 > 0) {
			System.out.println("Who would you like to attack? Currently alive enemies are:");
			System.out.println( enemy1 + ", " + enemy3 );
			System.out.println("Chose one: ENEMY1, ENEMY3");
			target = input.nextLine().trim().toUpperCase();
		}
		else if(BattleMode.health1 > 0 && BattleMode.health2 > 0 && BattleMode.health3 <= 0) {
			System.out.println("Who would you like to attack? Currently alive enemies are:");
			System.out.println( enemy1 + ", " + enemy2 );
			System.out.println("Chose one: ENEMY1, ENEMY2");
			target = input.nextLine().trim().toUpperCase();
		}
		else if(BattleMode.health1 <= 0 && BattleMode.health2 <= 0 && BattleMode.health3 > 0) {
			System.out.println("Who would you like to attack? Currently alive enemies are:");
			System.out.println( enemy3 );
			System.out.println("Chose one: ENEMY3");
			target = input.nextLine().trim().toUpperCase();
		}
		else if(BattleMode.health1 > 0 && BattleMode.health2 <= 0 && BattleMode.health3 <= 0) {
			System.out.println("Who would you like to attack? Currently alive enemies are:");
			System.out.println( enemy1 );
			System.out.println("Chose one: ENEMY1 ");
			target = input.nextLine().trim().toUpperCase();
		}
		else if(BattleMode.health1 <= 0 && BattleMode.health2 > 0 && BattleMode.health3 <= 0) {
			System.out.println("Who would you like to attack? Currently alive enemies are:");
			System.out.println( enemy2 );
			System.out.println("Chose one: ENEMY2");
			target = input.nextLine().trim().toUpperCase();
		}
			...
			if(target.equals("ENEMY1"))
			{
				...
				System.out.println("You did " + attack + " damage! Enemy health = " + BattleMode.health1);
				
				//Enemy attack
				attack = BattleMode.attack1;
				currentStats.setHealth(Math.max((currentStats.getHealth()-attack),0)); //removes user health
				System.out.println("The enemy did " + attack + " damage! Your health = " + currentStats.getHealth());
				System.out.println("");
				System.out.println("");
			}
			else if(target.equals("ENEMY2"))
			{
				...
				System.out.println("You did " + attack + " damage! Enemy health = " + BattleMode.health2);
